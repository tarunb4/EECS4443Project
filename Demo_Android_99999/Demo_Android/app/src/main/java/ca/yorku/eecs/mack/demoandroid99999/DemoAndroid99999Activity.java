package ca.yorku.eecs.mack.demoandroid99999;
 ...
 *
 * Login ID - tarunb4
 * Student ID - 217889742
 * last name - Bhardwaj
 * First name - Tarun
 */

/**
 * used the buttons "incrementButton", "decrementButton", "exitButton"
 * that were created and initialized them to be set once clicked.
 * initialized another button, "resetButton" for resetting the counter.
 * Under the onClick(View v) method, I added a else if statement to check if the reset button is clicked
 * if it is, then it resets the count to 0.
 *
 */
 ...
 */
public class DemoAndroid99999Activity extends Activity implements OnClickListener {
